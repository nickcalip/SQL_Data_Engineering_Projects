...
SELECT '=== Loading Skill Dimension For Skills Mart ===' AS info;
...
SELECT '=== Loading Date Month Dimension For Skills Mart ===' AS info;
...
CREATE TABLE skills_mart.fact_skill_demand_monthly (
    ...
    no_degree__mention_postings_count INTEGER,
...
INSERT INTO skills_mart.fact_skill_demand_monthly (
    ...
    no_degree__mention_postings_count
)
...
SELECT
    ...
    SUM(no_degree_mentioned) AS no_degree__mention_postings_count
...
UNION ALL
SELECT 'Date Month Dimensions', COUNT(*)
FROM skills_mart.dim_date_month
UNION ALL
SELECT 'Skill Demand Monthly', COUNT(*)
...
SELECT '=== Skill Demand Monthly ===' AS info;
